...
async function getImprovedCommit(commit) {
    const response = await cohere.generate({
        model: "a42dcfd7-2d89-4ec3-98aa-7d8af30d754f-ft",
        prompt: `
            Generate five commit message that follows the conventional commit and improve spelling. More info about conventional commits https://www.conventionalcommits.org/en/v1.0.0/
            --
...
export default getImprovedCommit