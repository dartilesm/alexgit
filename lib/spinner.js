...
function renderAllPhrases() {
    const phrasesPromise = renderPhrases(phrases, 2000)
    const waitingPhrasesPromise = renderPhrases(waitingPhrases, 5000)

    return Promise.all([phrasesPromise, waitingPhrasesPromise])
}
